...
![断路器模式状态机示意图](/assets/images/high_concurrency_system_design/circuit-breaker.png)
...
## 数据迁移
### 级联迁移方案
![级联迁移方案示意图](/assets/images/high_concurrency_system_design/data-migration-cascade-example.png)

![级联迁移方案回滚示意图](/assets/images/high_concurrency_system_design/data-migration-cascade-rollback-example.png)

这种方案的优点是简单易实施，业务上基本没有改造的成本；缺点是切写的时候需要短暂地停止写入，业务上是有损的。

### 双写方案
![双写方案示意图](/assets/images/high_concurrency_system_design/data-migration-double-write-example.png)
...
![CDN域名解析示意图](/assets/images/high_concurrency_system_design/cdn-example.png)
...
![削峰示意图](/assets/images/high_concurrency_system_design/message-load-shifting.png)

![异步示意图](/assets/images/high_concurrency_system_design/message-async.png)

![解藕示意图](/assets/images/high_concurrency_system_design/message-decouple.png)
...
![RPC调用过程示意图](/assets/images/high_concurrency_system_design/microservices-rpc.png)
...
## 注册中心
![注册中心示意图](/assets/images/high_concurrency_system_design/microservices-service-discovery.png)
...
![心跳机制示意图](/assets/images/high_concurrency_system_design/microservices-service-discovery-heartbeat.png)
...
![traceId+spanId示意图](/assets/images/high_concurrency_system_design/microservices-rpc-trace.png)
...
![代理类负载均衡示意图](/assets/images/high_concurrency_system_design/microservices-proxy-load-balance.png)
...
![客户端负载均衡示意图](/assets/images/high_concurrency_system_design/microservices-client-load-balance.png)
...
## API网关
![API网关示意图](/assets/images/high_concurrency_system_design/microservices-api-gateway.png)
...
常用组件监控指标：
![常用组件监控指标](/assets/images/high_concurrency_system_design/monitor-indicators.png)
...
![监控系统架构示意图](/assets/images/high_concurrency_system_design/monitor-architect-example.png)

APM(Application Performance Management)，应用性能管理，指的是对应用各个层面做全方位的监测，核心关注点是终端用户的使用体验，即端到端整体链路上的性能情况。

![APM系统示意图](/assets/images/high_concurrency_system_design/monitor-apm.png)
...
![全链路压测系统架构示意图](/assets/images/high_concurrency_system_design/pressure-test-example.png)