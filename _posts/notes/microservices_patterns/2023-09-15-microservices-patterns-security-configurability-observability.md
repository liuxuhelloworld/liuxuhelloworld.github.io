---
title: Security, Configurability, Observability
---
...
![authentication](/assets/images/microservices_patterns/security-authentication.jpeg)
...
You can sometimes eliminate the server-side session entirely. For example, many applications have API clients that provide their credentials, such as an API key and secret, in every request. As a result, there's no need to maintain a server-side session.
...
![microservice authentication](/assets/images/microservices_patterns/security-microservice-authentication.jpeg)
...
![microservice OAuth authentication](/assets/images/microservices_patterns/security-microservice-oauth-authentication.jpeg)

![microservice OAuth authentication](/assets/images/microservices_patterns/security-microservice-oauth-authentication-2.jpeg)
...
![configurability pull model](/assets/images/microservices_patterns/configurability-pull-model.jpeg)

The primary drawback of using a configuration server is that unless it's provided by the infrastruture, it's yet another piece of infrastructure that needs to be set up and maintained. Fortunately, there are various open source frameworks, such as Spring Cloud Config, which make it easier to run a configuration server.
...
![Observation Patterns](/assets/images/microservices_patterns/observation-patterns-overview.jpeg)
...
![log aggregation](/assets/images/microservices_patterns/observation-log-aggregation.jpeg)
...
![distributed tracing](/assets/images/microservices_patterns/observation-distributed-tracing.jpeg)
...
![application metrics](/assets/images/microservices_patterns/observation-application-metrics.jpeg)
...
![exception tracking](/assets/images/microservices_patterns/observation-exception-tracking.jpeg)
